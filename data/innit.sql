...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2018-08-31 08:43:43
-- 服务器版本： 5.7.21
-- PHP Version: 5.6.35
...
(1, 'admin', 'Admin', '73bd1bc6c87a5f8b6d00daef7a86b46d', '10b232', '/assets/img/avatar.png', 'admin@admin.com', 0, 1502029281, 1492186163, 1502029281, 'd3992c3b-5ecc-4ecb-9dc2-8997780fcadc', 'normal'),
...
CREATE TABLE IF NOT EXISTS `auth_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='分组表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='节点表' ROW_FORMAT=COMPACT;
...
INSERT INTO `test` (`id`, `admin_id`, `category_id`, `category_ids`, `week`, `flag`, `genderdata`, `hobbydata`, `title`, `content`, `image`, `images`, `attachfile`, `keywords`, `description`, `city`, `price`, `views`, `startdate`, `activitytime`, `year`, `times`, `refreshtime`, `createtime`, `updatetime`, `weigh`, `switch`, `status`, `state`) VALUES
...
INSERT INTO `user` (`id`, `group_id`, `username`, `nickname`, `password`, `salt`, `email`, `mobile`, `avatar`, `level`, `gender`, `birthday`, `bio`, `score`, `successions`, `maxsuccessions`, `prevtime`, `logintime`, `loginip`, `loginfailure`, `joinip`, `jointime`, `createtime`, `updatetime`, `token`, `status`, `verification`) VALUES
